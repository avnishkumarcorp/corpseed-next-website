            ...
            <div className="mx-auto max-w-7xl px-6 w-full">
              <div className="max-w-3xl">
                ...
                <div className="mt-7 flex flex-wrap gap-3">
                  <button className="px-6 py-3 rounded-xl bg-blue-600 hover:bg-blue-700 text-white font-semibold transition cursor-pointer">
                    Talk to an expert
                  </button>
                  <Link
                    href="#begin"
        ...
        <div className="rounded-3xl border border-gray-300 bg-gradient-to-br from-black to-gray-900 text-white p-10 md:p-14">
          <div className="flex flex-col-reverse lg:flex-row items-center justify-between gap-10">
            <div className="max-w-xl">
              ...
              <button className="mt-6 bg-white text-black px-7 py-3 rounded-full text-sm font-semibold hover:bg-gray-200 transition cursor-pointer">
