...
export const metadata = {
  title: "Partner With Us | Corpseed",
  description:
    "Join Corpseed’s partner network. Earn commissions, grow faster, and deliver compliance services smoothly across India.",
};
...
export default function PartnerWithUsPage() {
  return (
    <main className="bg-white">
      {/* HERO */}
      <section className="relative border-b border-gray-300 bg-gradient-to-b from-slate-50 to-white">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
            ...
            <div className="lg:col-span-7">
              ...
              <p className="mt-4 text-base md:text-lg text-gray-600 leading-relaxed max-w-2xl">
                ...
                provide our customers/Partners with a sound legal advice, consulting,
              ...
              <div className="mt-6 flex flex-col sm:flex-row gap-3">
                ...
                <Link
                  href="#advantages"
                  className="inline-flex items-center justify-center gap-2 rounded-xl border border-gray-300 bg-white px-6 py-3 text-gray-900 font-semibold hover:bg-slate-50 transition cursor-pointer"
                >
                  See Benefits
                </Link>
              </div>
            ...
            {/* Right - Clean card (looks premium on desktop) */}
            <div className="lg:col-span-5">
              <div className="rounded-2xl border border-gray-300 bg-white shadow-sm overflow-hidden">
                <div className="p-6 border-b border-gray-300 bg-slate-50">
      ...
      {/* HOW IT WORKS */}
      <section className="py-10 md:py-14 bg-slate-50 border-y border-gray-300">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center">
            <h2 className="text-2xl md:text-4xl font-bold text-gray-900">
          ...
          <div className="mt-8 flex flex-col sm:flex-row items-center justify-center gap-3">
            ...
            <Link
              href="/contact"
              className="inline-flex items-center justify-center gap-2 rounded-xl border border-gray-300 bg-white px-6 py-3 text-gray-900 font-semibold hover:bg-slate-100 transition cursor-pointer"
            >
              Talk to our team
            </Link>
          </div>
      ...
      {/* Bottom spacing (tight, not too much) */}
      <section className="py-10">
        <div className="max-w-7xl mx-auto px-6">
          <div className="rounded-2xl border border-gray-300 bg-white shadow-sm p-6 md:p-8 flex flex-col md:flex-row items-start md:items-center justify-between gap-6">
            <div>
...
function Pill({ text }) {
  return (
    <span className="rounded-full border border-gray-300 bg-white px-3 py-1">
      {text}
    </span>
  );
}
...
function StatRow({ icon: Icon, title, value }) {
  return (
    <div className="flex items-center justify-between gap-4 rounded-xl border border-gray-300 bg-white px-4 py-3">
...
function AdvCard({ title, desc, icon: Icon }) {
  return (
    <div className="rounded-2xl border border-gray-300 bg-white shadow-sm p-6 hover:shadow-md transition">
...
function StepCard({ step, title, desc, icon: Icon }) {
  return (
    <div className="rounded-2xl border border-gray-300 bg-white shadow-sm p-6 md:p-8">
      <div className="flex items-start justify-between gap-4">
        ...
        <div className="h-8 w-8 rounded-full border border-gray-300 bg-white flex items-center justify-center text-sm font-bold text-gray-900">
          {step}
        </div>
      </div>
